...
describe('parseJmhzGuids + opravné round-trip', () => {
  it('extracts idPodani and per-employee idFormulare from a řádné XML', () => {
    ...
    expect(idPodani).toMatch(/[0-9A-F-]{36}/);
    expect(formGuids['1912989694|4003134873918']).toMatch(/[0-9A-F-]{36}/);
    expect(formGuids['1000000001|4000000000001']).toMatch(/[0-9A-F-]{36}/);
